...
8. You can/should use any AI to help you, but please comment which one you used on your `README.md`. Bonus points, if you share or copy/paste the prompts used to make the AI write it. 
