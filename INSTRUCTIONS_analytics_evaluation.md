...
4. To start counting your 4-hour period, commit a blank `NOTES.md` in the repository root at the beginning of your test.
...
8. You can and should use AI support. Please mention which tools you used in your `NOTES.md` and optionally share key prompts.
...
A revised solution is expected to preserve the API contract while improving the code, and architecture.
