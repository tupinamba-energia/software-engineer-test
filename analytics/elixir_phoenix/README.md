...
## What Candidates Are Expected To Improve

Typical improvement areas include:

- move business logic out of controllers into proper context/service boundaries
- improve validation strategy and error consistency
- improve data model constraints and indexing
- improve stats query strategy and performance
- reduce coupling and clarify module responsibilities
- increase test coverage for correctness and edge cases
